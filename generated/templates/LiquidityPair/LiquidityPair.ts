...
export class LiquidityPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
...
export class LiquidityPair__removeLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class LiquidityPair extends ethereum.SmartContract {
  static bind(address: Address): LiquidityPair {
    return new LiquidityPair("LiquidityPair", address);
  }
  ...
  getReserves(): LiquidityPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new LiquidityPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_getReserves(): ethereum.CallResult<LiquidityPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint256,uint256)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new LiquidityPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidity(liquidity: BigInt): LiquidityPair__removeLiquidityResult {
    let result = super.call(
      "removeLiquidity",
    ...
    return new LiquidityPair__removeLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidity(
    liquidity: BigInt
  ): ethereum.CallResult<LiquidityPair__removeLiquidityResult> {
    let result = super.tryCall(
      "removeLiquidity",
      "removeLiquidity(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(liquidity)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LiquidityPair__removeLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
